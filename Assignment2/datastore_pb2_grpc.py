...
class DatastoreStub(object):
  ...
  def __init__(self, channel):
    ...
    self.sync = channel.unary_stream(
        '/Datastore/sync',
        request_serializer=datastore__pb2.ReplicatorRequest.SerializeToString,
        response_deserializer=datastore__pb2.ReplicatorResponse.FromString,
    )
...
def add_DatastoreServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'sync': grpc.unary_stream_rpc_method_handler(
          ...
          response_serializer=datastore__pb2.ReplicationResponse.SerializeToString,
      ),
